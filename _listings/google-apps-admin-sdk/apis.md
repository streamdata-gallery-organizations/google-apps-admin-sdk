...
- name: Google Apps Admin SDK API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-apps-admin-sdk/master/_listings/google-apps-admin-sdk/groupuniqueid-put.md
x-common:
- type: x-blog
